<nav class="flex justify-between pr-10 w-full bg-white shadow-sm max-md:flex-wrap max-md:pr-5 max-md:max-w-full">
    ...
    <div class="relative max-md:hidden flex  gap-1.5 items-center">
        <a href="{{ route('feed') }}" class="shrink-0 aspect-[1.12] w-[90px] flex flex-col justify-center items-center {{ request()->routeIs('feed') ? 'border-b border-sky-800 border-b-2': '' }}">
            ...
            <strong class="uppercase text-xs absolute bottom-2 {{ request()->routeIs('feed') ? 'text-sky-800' : 'hidden' }}">
                home
            </strong>
        </a>
        ...
        <a href="{{ route('chat') }}" class="relative  shrink-0 aspect-[1.12] w-[90px] flex flex-col justify-center items-center   {{ request()->routeIs('chat') ? 'border-b border-sky-800 border-b-2' : '' }} ">
