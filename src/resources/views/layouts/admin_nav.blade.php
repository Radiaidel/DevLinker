<nav class="flex justify-between pr-10 w-full bg-white shadow-sm max-md:flex-wrap max-md:pr-5 max-md:max-w-full">
    ...
    <div class="relative max-md:hidden flex  gap-1.5 items-center">
            ...
            <svg width="27px" height="27px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g id="SVGRepo_iconCarrier">
                    <g clip-path="url(#clip0_1251_98416)">
                        ...
                        <path d="M15.5 0C14.9477 0 14.5 0.447715 14.5 1C14.5 1.55228 14.9477 2 15.5 2C17.433 2 19 3.567 19 5.5C19 7.433 17.433 9 15.5 9C14.9477 9 14.5 9.44771 14.5 10C14.5 10.5523 14.9477 11 15.5 11C18.5376 11 21 8.53757 21 5.5C21 2.46243 18.5376 0 15.5 0Z" fill=" {{ request()->routeIs('users') ? '#075985' : '#080341' }}" />
                        <path d="M19.0837 14.0157C19.3048 13.5096 19.8943 13.2786 20.4004 13.4997C22.5174 14.4246 24 16.538 24 19V21C24 21.5523 23.5523 22 23 22C22.4477 22 22 21.5523 22 21V19C22 17.3613 21.0145 15.9505 19.5996 15.3324C19.0935 15.1113 18.8625 14.5217 19.0837 14.0157Z" fill=" {{ request()->routeIs('users') ? '#075985' : '#080341' }}" />
                        <path d="M6 13C2.68629 13 0 15.6863 0 19V21C0 21.5523 0.447715 22 1 22C1.55228 22 2 21.5523 2 21V19C2 16.7909 3.79086 15 6 15H12C14.2091 15 16 16.7909 16 19V21C16 21.5523 16.4477 22 17 22C17.5523 22 18 21.5523 18 21V19C18 15.6863 15.3137 13 12 13H6Z" fill=" {{ request()->routeIs('users') ? '#075985' : '#080341' }}" />
                    </g>
                    <defs>
        ...
        <a href="{{ route('explore') }}" class="shrink-0 aspect-[1.12] w-[90px] flex flex-col justify-center items-center {{ request()->routeIs('explore') ? 'border-b border-sky-800 border-b-2' : '' }}">
            <svg width="29px" height="29px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g id="SVGRepo_iconCarrier">
                    ...
                    <path d="M12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21Z" stroke=" {{ request()->routeIs('explore') ? '#075985' : '#080341' }}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </g>
        ...
        <a href="{{ route('support') }}" class="relative  shrink-0 aspect-[1.12] w-[90px] flex flex-col justify-center items-center   {{ request()->routeIs('support') ? 'border-b border-sky-800 border-b-2' : '' }} ">
            <svg width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g id="SVGRepo_iconCarrier">
                    <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 13.5997 2.37562 15.1116 3.04346 16.4525C3.22094 16.8088 3.28001 17.2161 3.17712 17.6006L2.58151 19.8267C2.32295 20.793 3.20701 21.677 4.17335 21.4185L6.39939 20.8229C6.78393 20.72 7.19121 20.7791 7.54753 20.9565C8.88837 21.6244 10.4003 22 12 22Z" stroke=" {{ request()->routeIs('support') ? '#075985' : '#080341' }}" stroke-width="2" />
                </g>

            </svg>
            <span id="admin.support_count" class="absolute bg-red-600 text-white h-4  w-4 text-center top-5  right-6 text-xs rounded-full {{request()->routeIs('support') ? 'hidden' : '' }}">{{auth()->user()->unreadMessagesCount()}}</span>
            <strong class="uppercase text-xs  absolute bottom-2  {{ request()->routeIs('support') ? 'text-sky-800' : 'hidden' }}">
                support
            </strong>
        </a>


        <a href="{{ route('notification') }}" class="aspect-[1.12] w-[90px] flex flex-col justify-center items-center {{ request()->routeIs('notification') ? 'border-b border-sky-800 border-b-2' : '' }}">
