...
<div class="flex flex-col pb-20  p-3">

  <div class="flex flex-col self-center mt-11 max-w-full md:w-[852px] max-md:mt-10">
    <div class="flex gap-0 items-end max-w-full text-xs text-center uppercase whitespace-nowrap w-[481px] max-md:flex-wrap">
      <div id="receivedBtn" class="justify-center items-center py-4 px-8 md:py-4 text-white bg-sky-800 rounded md:px-5 cursor-pointer">
        Received
      </div>
      <div id="sentBtn" class="justify-center items-center py-4 px-8 md:py-4 rounded bg-white border border-solid border-neutral-200 text-neutral-900   md:px-5 cursor-pointer">
        Sent
      </div>
    </div>
    ...
    <div id="recent_connections">
      ...
      <div class="flex md:gap-5 gap-2 px-5 mt-11 text-xs text-center uppercase text-neutral-900 max-md:flex-wrap max-md:mt-10 max-md:max-w-full">
        <div class="shrink-0 w-full border border-solid bg-neutral-200 border-neutral-200 h-[9px] md:w-[310px]"></div>
        <div class="flex-auto italic">recent connections</div>
        <div class="md:block hidden shrink-0 max-w-full border border-solid bg-neutral-200 border-neutral-200 h-[9px] w-[312px]"></div>
      </div>
