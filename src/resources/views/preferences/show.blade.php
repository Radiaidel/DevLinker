...
<div class="min-h-screen flex flex-col items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <form action="{{ route('delete-account') }}" method="POST">
            @csrf
            <button type="button" onclick="confirmDeleteAccount()" class="block w-full text-center py-2 bg-red-600 text-white font-semibold rounded-full hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">Supprimer mon compte</button>
        </form>
