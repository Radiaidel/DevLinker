...
<div class="flex gap-12 p-12">
    <div class="flex flex-col w-2/3">
        <div class="flex flex-col px-7 py-5 w-full bg-white rounded-3xl max-md:px-5 max-md:max-w-full">
            <div class="flex gap-5 text-lg text-neutral-900 text-opacity-20 max-md:flex-wrap max-md:max-w-full">
                <img loading="lazy" srcset="..." class="shrink-0 aspect-square w-[60px]" />
                <div class="grow justify-center items-start px-7 py-4 my-auto rounded-2xl bg-zinc-100 w-fit max-md:px-5 max-md:max-w-full">
                    Share something...
                </div>
            </div>
            <div class="flex gap-5 justify-between self-center mt-2 w-full text-xs whitespace-nowrap max-w-[700px] text-zinc-400 max-md:flex-wrap max-md:max-w-full">
                <div class="flex gap-5 justify-between items-start my-auto">
                    <div class="flex gap-1.5 self-stretch">
                        <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/a291150e8ba7e68d2858c0789c760dd40d3a80e1fb792c245d5d54b978a76957?" class="shrink-0 w-4 border border-solid aspect-[0.94] border-neutral-500 stroke-[1px] stroke-neutral-500" />
                        <div class="my-auto">Document</div>
                    </div>
                    <div class="flex gap-2.5">
                        <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/0be0440d9922f3abb648e6971b0730b987e31b95b0ff4b89da3042be2930dda2?" class="shrink-0 aspect-square w-[15px]" />
                        <div>Image</div>
                    </div>
                    <div class="flex gap-2">
                        <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/705a53f077f94d185f2b41e989dfaaeacb6027ba4e74106ff2878654f198d06f?" class="shrink-0 aspect-square w-[15px]" />
