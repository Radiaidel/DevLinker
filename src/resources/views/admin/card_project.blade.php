    ...
    <div class="grid gap-4">
        <div class="flex flex-col h-auto px-8 py-6 mt-10 w-full bg-white rounded-3xl shadow-lg text-neutral-900 max-md:px-5 max-md:max-w-full">
            ...
            <div class="flex justify-between items-center bg-red-200 border border-red-400 text-red-800 px-4 py-2 rounded-md mb-4">
                <div>
                ...
                <form action="{{ route('projects.softDelete', $project->id) }}" method="POST">
                    ...
                    <button type="submit" >
                        <svg class="my-auto" width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
