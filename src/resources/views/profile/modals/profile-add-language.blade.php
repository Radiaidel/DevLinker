        ...
        <div class="bg-white rounded-lg overflow-hidden max-w-lg w-full p-6 z-20">
            ...
            <form id="addLanguageForm" action="{{ route('add.language') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="language" name="language" class="mt-1 border py-2  block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>
                <div class="mb-4">
                    <label for="level" class="block text-sm font-medium text-gray-700">Level</label>
                    <select id="level" name="level" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm sm:text-sm">
                ...
                <div class="flex justify-end">
                    ...
                    <button type="submit" class="bg-sky-800 text-white px-4 py-2 rounded-md">Add</button>
                </div>
            </form>
        </div>
    </div>
